...
sp_coord_anno %>%
  ...
  geom_point() +
  xlab("log(body mass)")
ggsave("06_output_cluster_by_species/PC1_sp_pval_log_BM_HABM.pdf",width=6,height=4)
...
pdf("06_output_cluster_by_species/PC1_sp_pval_log_BM_HABM_phylomorphospace.pdf",width=8,height=8)
...
sink("06_output_cluster_by_species/bodymass_PC1_sp_pval_PGLSCorr.txt")
...
save(bm_hog_res,hog_phylo_spear_res,file ="06_output_cluster_by_species/bodymass_sp_pvals_spearman_res.Rdat")
#save(bm_hog_res,hog_phylo_spear_res,file ="06_output_cluster_by_species/bodymass_spomega_spearman_res.Rdat")
...
write_csv(corr_kk_summary,"06_output_cluster_by_species/bodymass_PC1_sp_pval_spearman_GSE_results_nocutoff.csv")

corr_kk_summary %>%
  filter(qvalues<0.3) %>%
  write_csv("06_output_cluster_by_species/bodymass_PC1_sp_pval_spearman_GSE_results_q<0.3.csv")
...
spear_enrich %>%
  write_csv("06_output_cluster_by_species/bodymass_PC1_sp_pval_spearman_enrich_results_nocutoff.csv")

spear_enrich %>%
  filter(qvalue<0.2) %>%
  write_csv("06_output_cluster_by_species/bodymass_PC1_sp_pval_spearman_enrich_results_q<0.2.csv")



##############Rerun everything using omega
pca_sp <- pca_omega
#pca_sp <- pca_weights
...
pdf("06_output_cluster_by_species/PC_individual_PC1_sp_omega.pdf")
plotBranchbyTrait(sp_tree_bl_names,sp_names_PC1,mode="tips",palette = "custom",use.edge.length=FALSE)
dev.off()
pdf("06_output_cluster_by_species/PC_individual_PC2_sp_omega.pdf")
plotBranchbyTrait(sp_tree_bl_names,sp_names_PC2,mode="tips",palette = "custom",use.edge.length=FALSE)
dev.off()
pdf("06_output_cluster_by_species/PC_individual_PC3_sp_omega.pdf")
plotBranchbyTrait(sp_tree_bl_names,sp_names_PC3,mode="tips",palette = "custom",use.edge.length=FALSE)
dev.off()
...
sp_coord_anno %>%
  ...
  geom_point() +
  xlab("log(body mass)")
ggsave("06_output_cluster_by_species/PC1_sp_omega_log_BM_HABM.pdf",width=6,height=4)
...
#Plot phylomorphospace plot of body size by PC1
pdf("06_output_cluster_by_species/PC1_sp_omega_log_BM_HABM_phylomorphospace.pdf",width=8,height=8)
phylomorphospace(sp_tree_bl,sp_coord_anno_df[, c("log_body_mean_mean_hbabm", "PC1")], label="off", xlab="log(body mass)", ylab="PC1")
dev.off()
...
bm_hbabm_pc1 <- gls(PC1 ~ log_body_mean_mean_hbabm,correlation=corBrownian(1,sp_tree_bl),data=sp_coord_anno_df)
ou_hbabm_pc1 <- gls(PC1 ~ log_body_mean_mean_hbabm,correlation=corMartins(1,sp_tree_bl),data=sp_coord_anno_df)
sink("06_output_cluster_by_species/bodymass_PC1_sp_omega_PGLSCorr.txt")
summary(bm_hbabm_pc1)
summary(ou_hbabm_pc1)
sink()
...
save(bm_hog_res,hog_phylo_spear_res,file ="06_output_cluster_by_species/bodymass_sp_omega_spearman_res.Rdat")
#load("06_output_cluster_by_species/bodymass_sppvals_spearman_res.Rdat")
...
corr_kk <- gseKEGG(geneList = Corr_loading_geneList,organism = "gga", keyType = "ncbi-geneid", nPerm = 1000, pvalueCutoff = 1,minGSSize = 10,by="DOSE")
corr_kk_summary <- as.data.frame(corr_kk)
write_csv(corr_kk_summary,"06_output_cluster_by_species/bodymass_PC1_sp_omega_spearman_GSE_results_nocutoff.csv")

corr_kk_summary %>%
  filter(qvalues<0.3) %>%
  write_csv("06_output_cluster_by_species/bodymass_PC1_sp_omega_spearman_GSE_results_q<0.3.csv")
...
spear_enrich %>%
  write_csv("06_output_cluster_by_species/bodymass_PC1_sp_omega_spearman_enrich_results_nocutoff.csv")

spear_enrich %>%
  filter(qvalue<0.2) %>%
  write_csv("06_output_cluster_by_species/bodymass_PC1_sp_omega_spearman_enrich_results_q<0.2.csv")
...
pdf("06_output_cluster_by_species/PC_individual_PC1_sp_weights.pdf")
plotBranchbyTrait(sp_tree_bl_names,sp_names_PC1,mode="tips",palette = "custom",use.edge.length=FALSE)
dev.off()
pdf("06_output_cluster_by_species/PC_individual_PC2_sp_weights.pdf")
plotBranchbyTrait(sp_tree_bl_names,sp_names_PC2,mode="tips",palette = "custom",use.edge.length=FALSE)
dev.off()
pdf("06_output_cluster_by_species/PC_individual_PC3_sp_weights.pdf")
plotBranchbyTrait(sp_tree_bl_names,sp_names_PC3,mode="tips",palette = "custom",use.edge.length=FALSE)
dev.off()
...
sp_coord_anno %>%
  ...
  geom_point() +
  xlab("log(body mass)")
ggsave("06_output_cluster_by_species/PC1_sp_weights_log_BM_HABM.pdf",width=6,height=4)
...
#Plot phylomorphospace plot of body size by PC1
pdf("06_output_cluster_by_species/PC1_sp_weights_log_BM_HABM_phylomorphospace.pdf",width=8,height=8)
phylomorphospace(sp_tree_bl,sp_coord_anno_df[, c("log_body_mean_mean_hbabm", "PC1")], label="off", xlab="log(body mass)", ylab="PC1")
dev.off()
...
bm_hbabm_pc1 <- gls(PC1 ~ log_body_mean_mean_hbabm,correlation=corBrownian(1,sp_tree_bl),data=sp_coord_anno_df)
ou_hbabm_pc1 <- gls(PC1 ~ log_body_mean_mean_hbabm,correlation=corMartins(1,sp_tree_bl),data=sp_coord_anno_df)
sink("06_output_cluster_by_species/bodymass_PC1_sp_weights_PGLSCorr.txt")
summary(bm_hbabm_pc1)
summary(ou_hbabm_pc1)
sink()
...
#Create a combo dataset with selected branches and species data
comb_data <- bsrel_sp_weights_res_sp_forcorr %>%
  rownames_to_column(var = "sp_abbr") %>%
  as.tibble %>%
  left_join(sp_coord_anno)
...
save(bm_hog_res,hog_phylo_spear_res,file ="06_output_cluster_by_species/bodymass_sp_weights_spearman_res.Rdat")
#load("06_output_cluster_by_species/bodymass_sppvals_spearman_res.Rdat")
...
corr_kk <- gseKEGG(geneList = Corr_loading_geneList,organism = "gga", keyType = "ncbi-geneid", nPerm = 1000, pvalueCutoff = 1,minGSSize = 10,by="DOSE")
corr_kk_summary <- as.data.frame(corr_kk)
write_csv(corr_kk_summary,"06_output_cluster_by_species/bodymass_PC1_sp_weights_spearman_GSE_results_nocutoff.csv")

corr_kk_summary %>%
  filter(qvalues<0.3) %>%
  write_csv("06_output_cluster_by_species/bodymass_PC1_sp_weights_spearman_GSE_results_q<0.3.csv")
...
spear_enrich %>%
  write_csv("06_output_cluster_by_species/bodymass_PC1_sp_weights_spearman_enrich_results_nocutoff.csv")

spear_enrich %>%
  filter(qvalue<0.2) %>%
  write_csv("06_output_cluster_by_species/bodymass_PC1_sp_weights_spearman_enrich_results_q<0.2.csv")
